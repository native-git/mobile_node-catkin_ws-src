...
rospy.init_node("alfred_waypoints_queue")
path_publisher = rospy.Publisher('/alfred/waypoint', Path, queue_size=10)
...
def get_plan():
	...
	plan = rospy.wait_for_message('alfred/waypoints/queue', Path)
