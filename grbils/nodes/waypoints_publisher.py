...
filename = './xiaoran_path.csv'

rospy.init_node("csv_to_waypoints")

plan_publisher = rospy.Publisher('roomba2/waypoints/queue', Path, queue_size=10)
...
def publish_plan():
	...
	with open(filename) as csvfile:
		...
		if test0 and test1 and test2:
			...
			#new_plan.poses.append(response[100])
			#for i in range(100,len(response)):
			#	if i % 200 == 0:
